...
export const productImages = {
  amethystCalmBracelet: '/products/amethyst-calm-bracelet.png',
  roseQuartzHeartBracelet: '/products/rose-quartz-heart-bracelet.png',
  amazoniteFlowBracelet: '/products/amazonite-flow-bracelet.png',
  blackTourmalineShieldBracelet:
    '/products/black-tourmaline-shield-bracelet.png',
  citrineConfidenceBracelet: '/products/citrine-confidence-bracelet.png',
  aquamarineTideBracelet: '/products/aquamarine-tide-bracelet.png',
  roseQuartzTumbledStone: '/products/rose-quartz-tumbled-stone.png',
  clearQuartzTumbledStone: '/products/clear-quartz-tumbled-stone.png',
  labradoriteFlashTumbledStone:
    '/products/labradorite-flash-tumbled-stone.png',
  blackObsidianTumbledStone: '/products/black-obsidian-tumbled-stone.png',
  carnelianSparkTumbledStone: '/products/carnelian-spark-tumbled-stone.png',
  clearQuartzClarityPoint: '/products/clear-quartz-clarity-point.png',
  amethystDreamPoint: '/products/amethyst-dream-point.png',
  roseQuartzHeartPoint: '/products/rose-quartz-heart-point.png',
  fluoriteFocusPoint: '/products/fluorite-focus-point.png',
  labradoriteAuroraPoint: '/products/labradorite-aurora-point.png',
  beginnerCrystalRitualSet: '/products/beginner-crystal-ritual-set.png',
  loveSelfCareCrystalSet: '/products/love-self-care-crystal-set.png',
  protectionCrystalSet: '/products/protection-crystal-set.png',
  sevenChakraCrystalSet: '/products/seven-chakra-crystal-set.png',
  moonlightPrismSuncatcher: '/products/moonlight-prism-suncatcher.png',
  goldenHoopCrystalSuncatcher:
    '/products/golden-hoop-crystal-suncatcher.png',
  celestialStarsSuncatcher: '/products/celestial-stars-suncatcher.png',
  infinityLightSuncatcher: '/products/infinity-light-suncatcher.png',
} as const
